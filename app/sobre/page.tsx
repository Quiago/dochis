  ...
  return (
    <main className="container prose">
      ...
      <ul>
        ...
        <li><strong>Licencias comprobables.</strong> Cada médico declara su número de licencia y lo mostramos con un enlace al registro oficial de la DHA, DOH o MOHAP, para que cualquiera pueda comprobarlo. Una revisión automática detecta licencias repetidas y perfiles sospechosos, y la comunidad puede reportar con &quot;Ya no está aquí&quot;.</li>
      </ul>
