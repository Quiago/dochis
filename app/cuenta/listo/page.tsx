...
const MESSAGES: Record<string, { title: string; text: string }> = {
  saved: { title: 'Perfil guardado', text: 'Tus datos quedaron confirmados por otros tres meses. Gracias por mantener la lista al día.' },
  ...
  return (
    <main className="container auth center">
      ...
      <div className="auth-box">
        <p><strong>Guarda el contacto del directorio</strong> para recibir los recordatorios. Cada tres meses te pediremos confirmar tus datos: solo tendrás que responder un mensaje.</p>
